...
//	连接到数据库
  ...
  //查询数据表的所有记录
    ...
    public void executeUpdate(String username,String password,String email,String phone,String birth,String sex,String address,String personal,String nickname){
    	try{
            String sql = "UPDATE userinformation SET password = '"+password+"', email ='"+email+"', phone ='"+phone+"', birth ='"+birth+"', sex ='"+sex+"', address ='"+address+"', personal ='"+personal+"', nickname ='"+nickname+"' WHERE username ='"+username+"'";
    ...
    public void executeADD(String username,String password,String email,String phone){
    	try{
            String sql = "INSERT userinformation VALUE(NULL,'"+username+"','"+password+"','"+email+"','"+phone+"',null,null,null,null,null)";
            st.executeUpdate(sql);
            }catch(SQLException e1) {    
                // TODO Auto-generated catch block    
                e1.printStackTrace();   
